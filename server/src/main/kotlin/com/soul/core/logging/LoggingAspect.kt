package com.soul.core.logging

import com.soul.core.config.ApplicationProfiles
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.soul.core.repository..*)" +
                " || within(com.soul.core.service..*)" +
                " || within(com.soul.core.web.rest..*)"
    )
    ...
    fun logAfterThrowing(joinPoint: JoinPoint, e: Throwable) {
        if (env.acceptsProfiles(Profiles.of(ApplicationProfiles.DEV))) {
